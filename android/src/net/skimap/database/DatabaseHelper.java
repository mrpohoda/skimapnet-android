...
public class DatabaseHelper extends SQLiteOpenHelper 
{
	...
	public void onCreate(SQLiteDatabase db) 
	{
		...
		TAB_SKICENTRE_API_LOCATION_ALTITUDE_UNDERMOST + " INTEGER," +
		TAB_SKICENTRE_API_LOCATION_ALTITUDE_TOPMOST + " INTEGER," +
		TAB_SKICENTRE_API_COUNT_LIFTS_OPENED + " INTEGER," +
		TAB_SKICENTRE_API_COUNT_DOWNHILLS_OPENED + " INTEGER," +
		TAB_SKICENTRE_API_LENGTH_CROSSCOUNTRY + " INTEGER," +
		TAB_SKICENTRE_API_LENGTH_DOWNHILLS_TOTAL + " INTEGER," +
		...
		TAB_SKICENTRE_API_SNOW_MAX + " INTEGER," +
